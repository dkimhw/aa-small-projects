...
const bakePie = (recipe, pieType, pieQuantity) => {
...
const getTotalCostofBaking = (costPerPie, pieQuantity) => {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  const costPerPie = getCostPerPie(recipe, pieQuantity);
  console.log(`Cost per pie: ${costPerPie}`);

  totalCost = getTotalCostofBaking(costPerPie, pieQuantity);
